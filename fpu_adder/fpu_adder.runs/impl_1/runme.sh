...
HD_PWD='D:/project/verilog_code_files/fpu_adder/fpu_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decimal_to_bram_bram_rom.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decimal_to_bram_bram_rom.tcl -notrace
