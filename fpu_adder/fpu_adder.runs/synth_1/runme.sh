...
HD_PWD='D:/project/verilog_code_files/fpu_adder/fpu_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decimal_to_bram_bram_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decimal_to_bram_bram_rom.tcl
